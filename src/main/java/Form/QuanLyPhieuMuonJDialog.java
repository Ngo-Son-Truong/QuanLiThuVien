...
public class QuanLyPhieuMuonJDialog extends javax.swing.JDialog {
    ...
    public boolean validateform(){
        if (txtMaPhieuMuon.getText().equals("")) {
            loipm.setText("Chưa Nhập Mã Phiếu Mượn!");
            return false;
        }else{
            loipm.setText("");
        }
         if (txtMaSach.getText().equals("")) {
             loisach.setText("Chưa Nhập Mã Sách!");
            return false;
        }else{
             loisach.setText("");
        }
        ...
        if (txtTenSach.getText().equals("")) {
            loiten.setText("Chưa Nhập Tên Sách");
            return false;
        }else{
            loiten.setText("");
        }
         ...
         if (txtMaDG.getText().equals("")) {
            loidg.setText("Chưa Nhập Mã Độc Giả!");
            return false;
        }else{
             loidg.setText("");
        }
         if (txtMaNV.getText().equals("")) {
             loinv.setText("Chưa nhập mã nhân viên");
            return false;
        }else{
             loinv.setText("");
        }
         if (dateMuon.getDate() == null ) {
             loimuon.setText("Chưa Nhập Ngày Mượn Sách!");
            return false;
        }else{
             loimuon.setText("");
        }
         if (dateTra.getDate()== null) {
             loitra.setText("Chưa Nhập Ngày Trả Sách!");
         } else {
             loitra.setText("");
         }
         return true;
    ...
    private void initComponents() {
        ...
        loipm = new javax.swing.JLabel();
        loisach = new javax.swing.JLabel();
        loiten = new javax.swing.JLabel();
        loidg = new javax.swing.JLabel();
        loinv = new javax.swing.JLabel();
        loimuon = new javax.swing.JLabel();
        loitra = new javax.swing.JLabel();
        ...
        loipm.setForeground(new java.awt.Color(255, 0, 51));

        loisach.setForeground(new java.awt.Color(255, 0, 0));

        loiten.setForeground(new java.awt.Color(255, 0, 0));

        loidg.setForeground(new java.awt.Color(255, 0, 0));

        loinv.setForeground(new java.awt.Color(255, 0, 0));

        loimuon.setForeground(new java.awt.Color(255, 0, 0));

        loitra.setForeground(new java.awt.Color(255, 0, 0));
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
            if (MsgBox.confirm(this, "Bạn thực sự muốn xóa Mã Phiếu Mượn Này này?")) {
            String manh = txtMaPhieuMuon.getText();
            try {
                dao.delMaPhieuMuonByID(manh);
                fillTable();
                this.row = -1;
    ...
    private javax.swing.JLabel loidg;
    private javax.swing.JLabel loimuon;
    private javax.swing.JLabel loinv;
    private javax.swing.JLabel loipm;
    private javax.swing.JLabel loisach;
    private javax.swing.JLabel loiten;
    private javax.swing.JLabel loitra;
